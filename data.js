...
[ {
...
},
 {
	...
	size	: [900,570],
	de		: ["der Regenschirm","die Katze","die Banane","das Ei","die Ente", "die Flasche", "die Lampe"],
	en		: ["the umbrella","the cat","the banana","the egg","the duck", "the bottle", "the lamp"],
	fr		: ["le parapluie","le chat","la banane","l'oeuf","le canard", "la bouteille", "la lampe"],
	mg		: ["ny elo","ny saka","ny akondro","ny atody","ny ganagana", "ny tavoahangy", "ny jiro"],
